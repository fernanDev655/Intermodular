...
public class GlobalExceptionHandler {
 ...
 // DATA ACCESS -> 500
    ...
    public ResponseEntity<Map<String, Object>> handleData(DataAccessException e) {
        ...
        // ESTA LÍNEA ES LA QUE NECESITAMOS AHORA:
        e.printStackTrace(); 

        Map<String, Object> response = new HashMap<>();
        // He cambiado esto para que el mensaje te de una pista extra en el navegador
        response.put("message", "Error de acceso a datos: " + e.getMessage());
